...
<main>
    ...
    <section class="buttons-section">
      ...
      <div class="button-card">
        ...
        <p class="button-desc">Просмотрите наш огромный ассортимент товаров.</p>
      </div>
      ...
      <!-- Готовые сборки -->
      <div class="button-card">
        <span class="button-title">Собрать комнату</span>
        <p class="button-desc">Создайте идеальную комнату для себя.</p>
      </div>
    </section>
    <div class="filter-section">
    <div class="accordion">
        <div class="accordion-item">
            <button class="accordion-header" onclick="toggleAccordion(this)">Выберите категорию</button>
            <div class="accordion-body">
                <label>
                    <input type="radio" name="category" value="shampoos" onclick="filterByCategory(this)"> Шампуни
                </label>
                <label>
                    <input type="radio" name="category" value="shower-gels" onclick="filterByCategory(this)"> Гели для душа
                </label>
                <label>
                    <input type="radio" name="category" value="dish-wash" onclick="filterByCategory(this)"> Средства для посуды
                </label>
                <label>
                    <input type="radio" name="category" value="cleaners" onclick="filterByCategory(this)"> Бытовая химия
                </label>
                <label>
                    <input type="radio" name="category" value="air-fresheners" onclick="filterByCategory(this)"> Освежители воздуха
                </label>
                <label>
                    <input type="radio" name="category" value="all" onclick="filterByCategory(this)"> Показать все
                </label>
            </div>
        </div>
    </div>
